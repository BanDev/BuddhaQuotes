...
val Symbols.Outlined.BookmarkHeart: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Outlined.BookmarkHeart",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 960f,
        viewportHeight = 960f
...
@PreviewLightDark
@Composable
private fun OutlinedBookmarkHeartPreview() {
    BuddhaQuotesTheme {
        Surface {
            Icon(imageVector = Symbols.Outlined.BookmarkHeart, contentDescription = null)
        }
    }
}
