...
val Images.AnahataDynamic: ImageVector
    @Composable
    get() {
        if (_AnahataDynamic != null) {
            return _AnahataDynamic!!
        }
        _AnahataDynamic = ImageVector.Builder(
            name = "AnahataPurple",
            defaultWidth = 512.dp,
            ...
            val end = MaterialTheme.colorScheme.primaryFixed
            val colorStops = arrayOf(
                0.32f to primary,
                0.47f to lerp(primary, end, 0.33f),
                0.75f to lerp(primary, end, 0.66f),
                0.9f to end
            )
            path(
...
private var _AnahataDynamic: ImageVector? = null

@Preview
@Composable
private fun AnahataPurplePreview() {
    BuddhaQuotesTheme {
        Box(modifier = Modifier.padding(12.dp)) {
            Image(imageVector = Images.AnahataDynamic, contentDescription = null)
        }
    }
}
