...
val Symbols.Filled.CalendarToday: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
@PreviewLightDark
@Composable
private fun FilledCalendarTodayPreview() {
    BuddhaQuotesTheme {
        Surface {
            Icon(imageVector = Symbols.Filled.CalendarToday, contentDescription = null)
        }
    }
}
