...
val Symbols.Filled.Refresh: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.Refresh",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
...
@PreviewLightDark
@Composable
private fun FilledRefreshPreview() {
    BuddhaQuotesTheme {
        Surface {
            Icon(imageVector = Symbols.Filled.Refresh, contentDescription = null)
        }
    }
}
