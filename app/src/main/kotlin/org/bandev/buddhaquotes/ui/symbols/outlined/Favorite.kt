...
val Symbols.Outlined.Favorite: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
@PreviewLightDark
@Composable
private fun OutlinedFavoritePreview() {
    BuddhaQuotesTheme {
        Surface {
            Icon(imageVector = Symbols.Outlined.Favorite, contentDescription = null)
        }
    }
}
