...
val Symbols.Filled.Settings: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
@PreviewLightDark
@Composable
private fun FilledSettingsPreview() {
    BuddhaQuotesTheme {
        Surface {
            Icon(imageVector = Symbols.Filled.Settings, contentDescription = null)
        }
    }
}
