...
val Symbols.Filled.LightMode: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
@PreviewLightDark
@Composable
private fun FilledLightModePreview() {
    BuddhaQuotesTheme {
        Surface {
            Icon(imageVector = Symbols.Filled.LightMode, contentDescription = null)
        }
    }
}
